...
const schema = yup.object({
    ...
    precio: yup.number('el precio solo puede contener numeros').required("El precio de la reserva es obligatorio"),
...
export default {
     getTourByQuery,createTour, updateTour, getTourByGuideId,deleteTour, createTours, findAll, getTour
};
